  ...
  return (
    ...
    >
      ...
      >
        ...
        {/*  点光光源   */}
        <pointLight color="#fff" position={[0, 0,5]}  intensity={2} />
        {/* 渲染的物体 */}
        ...
        <PresentationControls
          ...
          polar={[-Math.PI /6, Math.PI / 6]} //垂直极限控制
          azimuth={[-Math.PI /6, Math.PI / 6]} //水平极限控制
          config={{ mass: 1, tension: 100, friction: 100 }} // Spring的配置=》质量 张力 摩擦力
        >
          <Model
            scale={isPc?1:0.7}
            position={isPc?[0, -1, 0]:[0, -0.7, 0]}
            onPointerMissed={() => {
              console.log("动画结束");
            }}
          />
